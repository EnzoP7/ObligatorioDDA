...
public class Arbitro extends Persona{
            ...
            for (Arbitro elArbitro:listaArbitros){
                if (elArbitro.getId() == elId){
                    ...
                    if (jugo){
                        ...
                        System.out.println("Arbitro " + elArbitro.getNombre()+" " + elArbitro.getApellido() +" ha sido Eliminado");
                        return;
                    }
                }
            }
    ...
    public static void verPagos() {
        ...
        for (Arbitro elArbitro:listaArbitros){
            ...
            System.out.println(Nombre +" " + Apellido +": Partidos Arbitrados: "+partidosJugados +"  ---- TOTAL: $"+PagoTotal);
        }
    }
