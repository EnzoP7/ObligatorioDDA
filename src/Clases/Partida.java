...
// endregion
        ...
        if (Jugadores.listaJugadores.size() < 2 || Arbitro.listaArbitros.isEmpty()) {
            ...
            try {
                ...
                if (eloGanador < eloPerdedor) {
                    ...
                    RegistroPartidas ingresoRegistro = new RegistroPartidas(laPartida.id, elPlayer.getElo(), elPlayer2.getElo(), Puntos);
    ...
    public static void updatePartida() {
        ...
        Jugadores antiguoPerdedor = (antiguoGanador == jugador1) ? jugador2 : jugador1;
        ...
        if (esValida) {
            ...
            if (antiguoGanador != elGanador) {
                if (jugador1 == elGanador) {
                    if (elojugador1R > elojugador2R) {
                        int puntosNuevos = laDiferenciaR / 8;
                        elGanador.setElo(eloActualJugador1 + puntosDados);
                        elGanador.setElo(elGanador.getElo() + puntosNuevos);

                        // al perdedor ahora

                        elPerdedor.setElo(eloActualJugador2 - puntosDados);
                        elPerdedor.setElo(elPerdedor.getElo() - puntosNuevos);
                        ...
                        System.out.println("GANADOR: " + elPerdedor.getNombre() + " " + elPerdedor.getApellido() + "  Puntos Ganados: " + puntosDados + " " +
                                "Elo Actual: " + eloActualJugador2);
                        System.out.println("Perdedor: " + elGanador.getNombre() + " " + elGanador.getApellido() + "  Puntos Perdidos: " + puntosDados + " " +
                                "Elo Actual: " + eloActualJugador1);
                        System.out.println("--------------------------------------------------------------------------------------------------------------");
                        System.out.println("-------------------------- Datos Despues de Modificar ------------------------------------");
                        System.out.println("GANADOR: " + elGanador.getNombre() + " " + elGanador.getApellido() + "  Puntos GANADOS: " + puntosNuevos + " " +
                                "Elo Actual: " + elGanador.getElo());
                        System.out.println("Perdedor: " + elPerdedor.getNombre() + " " + elPerdedor.getApellido() + "  Puntos Perdidos: " + puntosNuevos + " " +
                                "Elo Actual: " + elPerdedor.getElo() + "\n");


                    }
                    if (elojugador1R < elojugador2R) {
                        int puntosNuevos = laDiferenciaR / 4;
                        elGanador.setElo(eloActualJugador1 + puntosDados);
                        elGanador.setElo(elGanador.getElo() + puntosNuevos);
                ...
                if (jugador2 == elGanador) {
                    if (elojugador2R > elojugador1R) {
                        int puntosNuevos = laDiferenciaR / 8;
                        elGanador.setElo(eloActualJugador2 + puntosDados);
                        elGanador.setElo(elGanador.getElo() + puntosNuevos);

                        // al perdedor ahora

                        elPerdedor.setElo(eloActualJugador1 - puntosDados);
                        elPerdedor.setElo(elPerdedor.getElo() - puntosNuevos);
                        System.out.println("PARTIDA MODIFICADA CON EXITO");
                        System.out.println(laPartida.toString());
                        System.out.println("-------------------------- Datos antes de Modificar ------------------------------------");
